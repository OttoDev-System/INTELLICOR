...
export default function SupportTickets() {
  return (
    <PageLayout
      ...
      description="Gerencie tickets e monitore SLAs"
      primaryAction={{
        label: "Novo Ticket",
        onClick: () => console.log("Novo ticket")
      }}
      showSearch
    >
      ...
      <EmptyState
        ...
        description="Tickets de suporte aparecerão aqui"
        action="Clique em 'Novo Ticket' para criar um"
      />
    </PageLayout>
  );
}
